# bash span_prediction/scripts/script_full_text_prediction_ms_only_prediction.sh
num_train_epochs=30
...
# SQUAD
outdir=~/rds/hpc-work/mediqa_output/prediction/full_text/ms_only_test_set # ./span_prediction/output/large/full_text # squad_trained/$dataset/num_epochs_$num_train_epochs/lr_$lr/seed_$seed/
# PAQ
# outdir = 
...
python3 -u span_prediction/run_qa_mediqa.py --model_name_or_path /home/co-chae/rds/hpc-work/mediqa_output/prediction/full_text/merged_minus_ms_val/checkpoint-738 \
    ...
    --test_file /home/co-chae/mediqa/span_prediction/data/error_only/test_set/test_set_processed_full_text_as_input_ms_only.json \
