...
# SQUAD
outdir=~/rds/hpc-work/mediqa_output/prediction/sent/merged_minus_ms_val # ./span_prediction/output/large/sent # squad_trained/$dataset/num_epochs_$num_train_epochs/lr_$lr/seed_$seed/
# PAQ
# outdir = 
...
python3 -u span_prediction/run_qa_mediqa.py --model_name_or_path michiyasunaga/BioLinkBERT-large \
    ...
    --train_file $datadir_error_only/merged_training_sets_sent_minus_ms_val.json --validation_file $datadir_error_only/ms_val_processed_sent_as_input.json \
