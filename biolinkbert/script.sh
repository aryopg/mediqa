...
datadir=/Users/chaeeunlee/Documents/VSC_workspaces/mediqa/biolinkbert/data #../data/qa/$task
...
# SQUAD
outdir=/Users/chaeeunlee/Documents/VSC_workspaces/mediqa/biolinkbert/output # squad_trained/$dataset/num_epochs_$num_train_epochs/lr_$lr/seed_$seed/
# PAQ
# outdir = 
...
python3 -u biolinkbert/run_qa_mediqa.py --model_name_or_path michiyasunaga/BioLinkBERT-base \
    ...
    --train_file $datadir/ms_val_processed.json --validation_file $datadir/ms_val_processed.json --test_file $datadir/ms_val_processed.json \
